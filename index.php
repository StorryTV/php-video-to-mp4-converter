...
<html>
	<head>
		...
		<style type="text/css">
			...
			input[type="submit"], a#download {font-size:28px;border:none;border-radius:5px;background-image:linear-gradient(#7100e2,#58427b,#271212);color:#fff;box-shadow:2px 2px 5px #777;}
